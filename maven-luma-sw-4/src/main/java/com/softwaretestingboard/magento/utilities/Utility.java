...
public class Utility extends ManageBrowser {
    ...
    /**
     * This method will clear element value
     */
...
//*************************** Action Methods ***************************************//
    ...
    public List<Double> getPriceList(By by, String targetValue, String replaceValue) {
        List<WebElement> list = getListOfElements(by);
        List<Double> listValue = new ArrayList<>();
        for (WebElement value : list) {
            listValue.add(Double.valueOf(value.getText().replace(targetValue, replaceValue)));
